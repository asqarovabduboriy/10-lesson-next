...
import {incrementCartQuantity, decrementCartQuantity} from '../../context/cartSlice'
    ...
    <>
      ...
      <div className="text_contnet_single">
        ...
        <div className="increment">
          <div className="count">
            <button onClick={()=>dispatch(decrementCartQuantity(data))}>-</button>
            <button>{data?.quantity}</button>
            <button onClick={()=>dispatch(incrementCartQuantity(data))}>+</button>
          </div>
